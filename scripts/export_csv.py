"""从 SQLite 重新生成 data/export/*.csv(确定性导出)。
...
from app.data_store import EXPORT_DIR, export_csv_files  # noqa: E402
    ...
    if "--check" in sys.argv:
        with tempfile.TemporaryDirectory() as td:
            ...
            mismatched = [
                ...
                if (Path(td) / name).read_bytes() != (EXPORT_DIR / name).read_bytes()
            ]
        if mismatched:
